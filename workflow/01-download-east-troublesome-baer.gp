# Download Burn Area Emergency Response data from the USFS archive and create soil burn severity layer:
...
WebGet(URL="https://edcintl.cr.usgs.gov/downloads/sciweb1/shared/MTBS_Fire/data/baer/east_troublesome_sbs.zip",OutputFile="downloads/USFS-EastTroublesome-BAER/east_troublesome_sbs.zip",Timeout="10")
...
# WriteRasterGeoLayerToFile(GeoLayerID="EastTroublesomeSBSRasterLayer",OutputFile="../data/east-troublesome-2020-sbs.tif",OutputCRS="EPSG:4326")
WriteRasterGeoLayerToFile(GeoLayerID="EastTroublesomeSBSRasterLayer",OutputFile="../data/east-troublesome-2020-sbs.tif")
# Read the created file to confirm that it is OK.
ReadRasterGeoLayerFromFile(InputFile="../data/east-troublesome-2020-sbs.tif",GeoLayerID="EastTroublesomeSBSRasterLayer2",Name="East Troublesome Burn Severity (raster)",Description="East Troublesome Burn Severity (raster)")
